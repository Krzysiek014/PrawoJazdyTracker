...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(
                        HttpMethod.GET,
                        "/website/login/index.html", "/website/register/index.html", "/static/**", "/*.js", "/*.json", "/*.ico")
                .permitAll()
                .antMatchers(HttpMethod.POST, "/userApi/register")
                .permitAll()
                .anyRequest()
                .authenticated()
                .and()
                .formLogin()
                .loginPage("/website/login/index.html")
                .loginProcessingUrl("/login")
                .defaultSuccessUrl("/website/home/index.html", true)
                .failureUrl("/website/login/index.html?error=true");
    }
